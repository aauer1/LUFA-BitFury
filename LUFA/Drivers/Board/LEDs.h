...
#define __LEDS_H__
	...
	/* Includes: */
        ...
        #elif (BOARD == BOARD_BitfuryBTC)
                #include "AVR8/BitfuryBTC/LEDs.h"
        #elif (BOARD == BOARD_AvalonBTC)
                #include "AVR8/AvalonBTC/LEDs.h"
        #elif (BOARD == BOARD_XilinxFpgaBoard)
                #include "AVR8/XilinxFpgaBoard/LEDs.h"
        #else
